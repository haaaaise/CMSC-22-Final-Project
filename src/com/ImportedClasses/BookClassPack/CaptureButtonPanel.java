 ...
 */
@SuppressWarnings({"FieldCanBeLocal", "deprecation", "rawtypes"})
public class CaptureButtonPanel extends JPanel
{
  ...
  private void init()
  {
    ...
    dirTextField.addActionListener(e -> {
      FrameSequencer frameSequencer12 = videoHandler.getFrameSequencer();
      String dir1 = dirTextField.getText();
      frameSequencer12.setDirectory(dir1);
    });
    ...
    pickRegionButton.addActionListener(e -> {
...
//    add(secField);
    ...
    startButton.addActionListener(e -> {
      ...
      {
        Rectangle region = videoHandler.getRegion();
        FrameSequencer frameSequencer1 = videoHandler.getFrameSequencer();
        int framesPerSec = videoHandler.getFramesPerSecond();
        t = new Thread(new StartMovieCapture(frameSequencer1,
                                                    framesPerSec,
                                                    region));
        startButton.setEnabled(false);

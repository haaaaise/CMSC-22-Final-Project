...
//    }
  ...
  private void setUpIndexPanel(JPanel indexPanel)
  {
    ...
    firstButton.addActionListener(evt -> {
      currentPixelPosition = 0;
      updateIndexValues();
      checkScroll();
      soundFrame.getContentPane().repaint();
    ...
    lastButton.addActionListener(evt -> {
      currentPixelPosition = (int) ((sound.getNumSamples() - 1) / framesPerPixel);
      updateIndexValues();
      checkScroll();
      soundFrame.getContentPane().repaint();
    ...
    indexValue.addActionListener(e -> {
    ...
    numSamplesPerPixelField.addActionListener(e -> {
  ...
  {
    if(Objects.equals(e.getActionCommand(), "Play Entire Sound"))
    {
      try
      {
        sound.play();
    ...
    else if(Objects.equals(e.getActionCommand(), "Play Selection"))
    {
      try
      {
  ...
  public void checkScroll()
  {
    ...
    if (sampleWidth != zoomOutWidth) {
      ...
      // get the maxismum possible index
  ...
  private class SamplingPanel extends JPanel
  {
    ...
    private final Vector<Point2D.Float> points;

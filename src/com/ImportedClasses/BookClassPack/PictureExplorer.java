...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
 ...
 private void setUpNextAndPreviousButtons()
 {
   ...
   xPrevButton.addActionListener(evt -> {
     xIndex--;
     if (xIndex < 0)
       xIndex = 0;
   ...
   yPrevButton.addActionListener(evt -> {
     yIndex--;
     if (yIndex < 0)
       yIndex = 0;
     displayPixelInformation(xIndex,yIndex);
   ...
   xNextButton.addActionListener(evt -> {
     xIndex++;
   ...
   yNextButton.addActionListener(evt -> {
     yIndex++;
 ...
 public JPanel createLocationPanel(Font labelFont) {
   ...
   xValue.addActionListener(e -> displayPixelInformation(xValue.getText(),yValue.getText()));
   yValue = new JTextField(Integer.toString(yIndex + numberBase),6);
   yValue.addActionListener(e -> displayPixelInformation(xValue.getText(),yValue.getText()));
 ...
 public void checkScroll()
 {
   ...
   if (zoomFactor > 1) {
     ...
     // get the maxismum possible x and y index

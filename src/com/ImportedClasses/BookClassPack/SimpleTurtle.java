...
public class SimpleTurtle
{
  ...
  public synchronized void paintComponent(Graphics g)
  {
    ...
    if (visible)
    {
      ...
      int halfWidth = width/2; // of shell
      int halfHeight = height/2; // of shell
      int quarterWidth = width/4; // of shell
      int thirdHeight = height/3; // of shell
      int thirdWidth = width/3; // of shell
      
      // draw the body parts (head)
      g2.setColor(bodyColor);
      g2.fillOval(xPos - quarterWidth,
                  yPos - halfHeight - (height/3),
  ...
  public synchronized void drawInfoString(Graphics g) 
  {
    ...
    g.drawString(this.toString(),xPos + (width/2),yPos);
  }

...
public abstract class AbstractShape {
  ...
  protected final Color color = Color.black;  // color to draw shape in
  /** the first point in the shape */
  protected final Point p1 = new Point(); // first point
  /** the second point in the shape */
  protected final Point p2 = new Point(); // second point

...
// listeners.
  ...
  private void displayGameInstructions() {
    try {
      BufferedImage image = ImageIO.read(MainFrame.class.getResource("/images/game_instructions.jpg"));
  ...
  private void createMainMenuQuitPopupMenu() {
    ...
    JButton quitReturnBtn = new JButton("No");

    quitPopupOptionsPanel.add(quitConfirmBtn);
    quitPopupOptionsPanel.add(quitReturnBtn);
    ...
    quitReturnBtn.addActionListener(e -> mainMenuQuitPopup.setVisible(false));
  }
  ...
  public void createPlayerNameAssignDialog() {
    ...
    JButton playerAssignPlayBtn = new JButton("Play");
    JButton playerAssignReturnBtn = new JButton("Return");
    playerAssignActionsPanel.add(playerAssignPlayBtn);
    playerAssignActionsPanel.add(playerAssignReturnBtn);
    ...
    playerAssignPlayBtn.addActionListener(e -> {
      playerAxisName = playerAxisTextField.getText();
      playerAllyName = playerAllyTextField.getText();

      if (Board.isDebugMode()) {
        System.out.println("Axis player: " + playerAxisName + " designated!");
        System.out.println("Ally player: " + playerAllyName + " designated!");
      }
    ...
    playerAssignReturnBtn.addActionListener(e -> {
  ...
  private void createMenuBarQuitPopupMenu() {
    ...
    JLabel quitMessageLbl = new JLabel("Go back to main menu?");
